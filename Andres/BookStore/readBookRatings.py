...
from BookDetails.models import BOOK, BOOK_RATING 

count = 0
data = csv.reader(open("/home/HOMEGROUP/adelg000/school/CEN4010/BookStore/sample_data/BOOK_RATING.csv"),delimiter=",")
