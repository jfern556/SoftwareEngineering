...
class BOOK (models.Model):
    ...
    GenreID =  models.ForeignKey(GENRE, on_delete=models.SET_NULL, null=True)
    AuthorID =  models.ForeignKey(AUTHOR, on_delete=models.SET_NULL, null=True)
    PublisherID =  models.ForeignKey(PUBLISHER_INFO, on_delete=models.SET_NULL, null=True)
...
class CART_CONTENT (models.Model):
    ...
    ISBN =  models.ForeignKey(BOOK, on_delete=models.CASCADE, null=True) 
...
class PREFERRED_CREDIT_CARD (models.Model): 
    ...
    C_card_number =  models.ForeignKey(CREDIT_CARD, on_delete=models.CASCADE, null=True)
...
class USER (models.Model):
    ...
    Home_address_ID =  models.ForeignKey(USER_HOME_ADDRESS, on_delete=models.SET_NULL, null=True)

    Preferred_credit_card_ID =  models.ForeignKey(PREFERRED_CREDIT_CARD, on_delete=models.SET_NULL, null=True)
